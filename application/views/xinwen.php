...
<div class="wrapper">
	...
	<div id="main">
		<div id="info">
			<p><img class="title" src="../../images/xinwen3.png">
			隶属于华东交通大学新闻中心日新网，下设编辑部和记者团两个部门。现有成员30余人，设有总编辑一名，中文编辑两名，记者团团长一名，助理编辑若干，记者若干。曾多次获得教育部中国大学生在线高校百佳网站，江西省十大科教文网站等荣誉。目前主要负责日新网网站内容的更新，在做好这些工作的同时，我们积极进取，进行网页专题制作，同时积极迎接新媒体变革，开始制作信息图表，微信H5专题等内容，紧随发展。在未来的工作中，新闻出版中心全体成员将牢记“责任，合作，进取，创新”八字站训，不断的提升自身的多方面建设，为日新网的发展做出更大的贡献。</p>
		</div>			
	...
	<!-- effect4为点击编辑部出现的介绍页面 -->
		<div id="effect4">
			<div class="jizhe_l">
				...
				<ul>
					<li>职位要求：</li>
					<li>1、熟悉学校的主要情况和历史和日新网的组织架构。</li>
					<li>2、对日新网的新闻网站的稿件有所熟悉和了解。</li>
					<li>3、具有一位编辑人员的基本素养和随机应变能力。</li>
					<li>4、对现在新流行的各种媒体的基本功能和初步应用的理解。</li>
					<li>5、简单使用ps进行图集图标制作</li>
					<li>6、具有合作意识和团队精神。</li>
					<li>7、具有良好的思维逻辑能力和口头表达能力。</li>
					<li>8、2014级以上人员可以报名。</li>
				</ul>
			</div>
			<div class="jizhe_t">
				<div class="info">
	...
	<!-- effect2为点击记者团出现的介绍页面 -->
		<div id="effect2">
			<div class="jizhe_r">
				...
				<ul>
					<li>职位要求：</li>
					<li>1、新闻敏感性强，需要有一定的文字功底；</li>
					<li>2、有团队合作精神，并有较强的责任心和工作热情；</li>
					<li>3、熟悉常规办公软件常用操作（如word等)。</li>
				</ul>
			</div>
			<div class="jizhe_t">
	...
	<div id="footer">
		<div class="nav">
			<div class="line">
				...
				<div class="l2"></div>
				<a class="logo" href="/index.php/hr/xinwen"></a>
				<div class="l3_e"></div>
		...
		<div id="edit">
			...
			<div id="form">
				<form method="post" accept-charset="UTF-8" action="http://hr.ecjtu.net/index.php/register/check">
					...
					<p><span>性别-</span><label for="male"><input type="radio"style="margin-left:46px;" name="user_sex" class="radio" id="male" value="男" checked/> 男</label>
					<label for="female"><input type="radio" name="user_sex" class="radio" id="female" value="女" /> 女</label></p>
