...
?>
  <li>
    ...
    <span class="qq double" style="height: auto;"><a href="http://wpa.qq.com/msgrd?V=1&Uin=<?php echo $data->user_qq ?>" target="_blank"><?php echo $data->user_qq ?></a></span>
...
?>
<p><?php echo anchor('bg/out', '退出','class="quit"'); ?><?php if($access>=2) echo anchor('table_export/index', '下载excel表','class="quit"'); ?></p>
