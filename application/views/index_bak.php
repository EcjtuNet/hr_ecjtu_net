	...
	<div id="content">
    	<div id="content_main">
        	<div id="content_title">
            	<div id="text_block">
                	<span style="width:94px; height:19px; float:left; margin-left:607px;">
                    	<a href="index.php/hr/intro_news">职位详情</a>
                    </span>
                    <span style="height:19px; float:left; margin-left:132px; width:76px;">
                    	<a href="http://www.ecjtu.net/about/">我们一家</a>
                    </span>
                </div>
            	<div id="link_block">
                    ...
                    <div id="market" class="b_link"><a href="index.php/hr/intro_product"><img src="images/index_image/market.gif" style='display:block;width:108px;height:108px;margin:auto;margin-top:8px;position:relative;' onmouseDown='startMove(event)' onmouseUp='stopMove(event)'onmouseOver='moveTop(event)' onmouseOut='moveBot(event)'/></a></div>
                </div>
            </div>
            <div id="content_tail">
            	<span style="width:100px; height:18px; float:left; margin-top:18px; margin-left:433px"><a href="http://www.ecjtu.net">返回日新首页</a></span>
            </div>
        </div>      
    </div>
</body>
