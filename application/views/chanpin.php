...
<div class="wrapper">
	...
	<!-- effect为点击start出现的页面 -->
		<div id="effect">
			<div class="content">
				<div class="btns_top">
					<a id="app" class="btn0" onclick="changeReturn();hideEffectTemplate5('effect6','effect2','effect3','effect5','effect4')">手机客户端</a>
		...
		<!-- 此时return为返回到上一页 -->
				<a id="return2" onclick="hideEffectTemplate7('return','effect2','effect3','effect4','return2','effect5','effect6')"></a>
	...
	<div id="footer">
		<div class="nav">
			<div class="line">
				...
				<div class="l2"></div>
				<a class="logo" href="chanpin.html"></a>
				<div class="l4"></div>
			</div>
			<div class="tips">
